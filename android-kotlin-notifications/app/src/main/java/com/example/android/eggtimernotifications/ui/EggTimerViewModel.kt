...
//  EggTimerViewModel is responsible for starting and canceling the timer and for other lifecycle-related app tasks.
    ...
    private fun startTimer(timerLengthSelection: Int) {
        _alarmOn.value?.let {
            if (!it) {
                ...
                notificationManager.cancelNotifications() // Call cancelNotifications() from NotificationUtils() 1.14
