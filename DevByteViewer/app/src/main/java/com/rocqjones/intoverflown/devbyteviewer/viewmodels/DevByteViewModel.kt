package com.rocqjones.intoverflown.devbyteviewer.viewmodels
...
import com.rocqjones.intoverflown.devbyteviewer.network.asDomainModel
...
class DevByteViewModel(application: Application) : AndroidViewModel(application) {
    ...
    // From ln 41 - 55 is what we call repository pattern. Clean code
